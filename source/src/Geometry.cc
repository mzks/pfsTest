...
// Define materials
   ...
   Al = new G4Material("Aluminum", z=13., a=26.98*g/mole, density=2.700*g/cm3);

   Sci = new G4Material("Scintillator", density= 1.032*g/cm3, ncomponents=2);
   Sci->AddElement(C, natoms=9);
   Sci->AddElement(H, natoms=10);

   SilicaGel = new G4Material("SilicaGel", density= 0.55*g/cm3, ncomponents=2);
   ...
   G4Tubs* solid22NaCase = new G4Tubs("solid22NaCase",
		   0,
		   10.0 * mm,
		   3.0 * mm,
		   0.0,
   ...
   G4LogicalVolume* logicNa22 = new G4LogicalVolume(solidNa22,	
		   Sci,	
		   "Na22");

  G4VisAttributes* na22VisAtt = new G4VisAttributes(G4Colour(0.5,0.5,0.2));
  na22VisAtt->SetVisibility(true);
  logicNa22->SetVisAttributes(na22VisAtt);

 
  new G4PVPlacement(0,		
		    G4ThreeVector(0.,0.,param.fNa22Z),
		    logicNa22,		
		    "Na22",		
		    logicWorld,			
		    false,			
   ...
   new G4PVPlacement(trans3D_LogV, "PhysVol_NaI", logNaI, physVol_World, 
